...
<head>
    ...
    <title>AR-{{\App\Models\TestSeo::findOrfail(1)->title }}</title>
    ...
    <![endif]-->
     ...
     <!-- <link rel="stylesheet" href="{{asset('frontend/css/style_ar/style.css')}}" type="text/css"> -->
                ...
                <div class="topbar-right-items pull-right">
                    <ul class="toplist toppadding">
                     ...
                     <!-- <ul class="toplist toppadding">
                        ...
                        <li>lang</li>
                        <li><button id="changelang">EN</button></li>
                    </ul>
         -->
                </div>
            </div>
                                ...
                                <div class="main-nav">
                                    ...
                                    <div id="menu" class="collapse">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="right"><a href="http://{{ \App\Models\SoicalMedia::findOrfail(1)->facebook }}.com"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="row">
                    <div class=" col-md-12 col-centered text-center">
                        ...
                        <ul class="footer-quick-links">
                            ...
                            <li class="right"> <a href="{{URL('/website')}}">{{ Lang::locale() }}</a> <span class="arrow"></span></li>
                            <li class="right"> <a href="{{URL('/website')}}">@lang('tr.Home')</a> <span class="arrow"></span></li>
                            <li class="right"> <a href="{{URL('/about_us')}}">ABOUT US</a> <span class="arrow"></span> </li>
                            <li class="right"> <a href="{{URL('/choose_elamin')}}">Choose Future</a> <span class="arrow"></span> </li>
                        ...
                        <ul class="footer-social-icons round">
                            ...
                            <li><a href="http://{{ \App\Models\SoicalMedia::findOrfail(1)->facebook }}.com"><i class="fa fa-facebook"></i></a></li>
