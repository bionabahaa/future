...
<div class="container">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="btn-lg">
            ...
            <a href="{{URL('/team ')}}" class="btn btn-block btn-info"><i class="fa  fa-arrow-left"></i> <span></span>Bcak To List </a>
        </div>
    </div>
</div>
@endsection
@section('main')
    ...
    @endif
<div class="container">
    <form method="post"  action="{{ route('team.store') }}" enctype="multipart/form-data" class="border">
